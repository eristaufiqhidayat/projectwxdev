...
class Untitled1Frm : public wxFrame
{
	...
	public:
		Untitled1Frm(wxWindow *parent, wxWindowID id = 1, const wxString &title = wxT("EntriData"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = Untitled1Frm_STYLE);
